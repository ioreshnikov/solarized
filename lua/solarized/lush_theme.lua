...
theme.neotree = lush(function ()
    return {
        ...
        NeoTreeIndentMarker { fg = color.xxx_over_base05 },
...
theme.lualine = lush(function ()
    return {
        LualineANormal { gui = fmt.bold, fg = color.base1, bg = color.base04 },
        ...
        LualineAInsert { gui = fmt.revb, fg = color.base1, bg = color.base05 },
        LualineBInsert { LualineBNormal },
        LualineCInsert { LualineCNormal },
        LualineAVisual { gui = fmt.revb, fg = color.violet, bg = color.base05 },
        LualineBVisual { LualineBNormal },
        LualineCVisual { LualineCNormal },
        LualineAReplace { gui = fmt.revb, fg = color.orange, bg = color.base05 },
        LualineBReplace { LualineBNormal },
        LualineCReplace { LualineCNormal },
        LualineACommand { gui = fmt.revb, fg = color.magenta, bg = color.base05 },
