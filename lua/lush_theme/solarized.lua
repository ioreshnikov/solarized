...
theme.treesitter = lush(function ()
    return {
        ...
        TSCharacter { gui = fmt.none, fg = color.cyan, bg = color.none } , -- Character literals: `'a'` in C.
        ...
        TSMethod { gui = fmt.none, fg = color.blue, bg = color.none } , -- Method calls and definitions.
